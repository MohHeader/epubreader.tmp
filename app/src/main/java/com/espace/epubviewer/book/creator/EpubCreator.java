...
import com.espace.epubviewer.book.EpubBook;
import com.espace.epubviewer.book.EpubPage;
import com.espace.epubviewer.models.Page;
import com.espace.epubviewer.EpubView;
import com.espace.epubviewer.models.PageDBHandler;
...
public class EpubCreator {
    ...
    private void resetVariables(float size) {
        ...
        chapterNumber = 0;
        totalPages = 0;
        MAX_CHARACTERS =  epubView.getBook().getContext().getResources().getInteger(R.integer.characters_per_page);
        relativeSize = size;
        isInturrupted = false;
        lastChapterNumber = 0;
    }
